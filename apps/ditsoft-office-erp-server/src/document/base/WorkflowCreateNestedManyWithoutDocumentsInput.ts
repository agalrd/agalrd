...
@InputType()
class WorkflowCreateNestedManyWithoutDocumentsInput {
...
export { WorkflowCreateNestedManyWithoutDocumentsInput as WorkflowCreateNestedManyWithoutDocumentsInput };
