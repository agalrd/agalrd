...
@InputType()
class PayrollRecordCreateNestedManyWithoutEmployeesInput {
...
export { PayrollRecordCreateNestedManyWithoutEmployeesInput as PayrollRecordCreateNestedManyWithoutEmployeesInput };
